 ...
 * @api axios.create(config) - 初始化定制配置，覆盖默认配置
 * @use @app.js-onLaunch：axios.create(config);   @page.js: axios.post(url[, data[, config]]);
...
axios.create = axiosInstance.create.bind(axiosInstance);
